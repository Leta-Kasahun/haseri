        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
          <div className="flex-1 text-center lg:text-left mt-8 lg:mt-20">
            ...
            <motion.h1
              ...
              className="text-5xl md:text-8xl font-black font-heading tracking-tighter uppercase leading-[0.9] text-foreground mb-8"
            >
              Hire <span className="text-primary">Expert</span> <br className="hidden sm:block" /> Professionals.
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-base md:text-xl text-muted-foreground mb-8 md:mb-10 max-w-lg mx-auto lg:mx-0 leading-relaxed"
            >
            ...
            >
              ...
              <Button size="lg" variant="outline" className="w-full sm:w-auto rounded-none px-8 md:px-10 h-12 md:h-14 text-base md:text-lg border-2 border-foreground hover:bg-foreground hover:text-background transition-all active:scale-95" asChild>
            ...
            >
              <div className="flex flex-col items-center lg:items-start">
                <span className="text-2xl md:text-3xl font-black text-foreground">10K+</span>
                <span className="text-[8px] md:text-[10px] text-primary uppercase tracking-[0.2em] font-black">Jobs Done</span>
              </div>
              <div className="flex flex-col items-center lg:items-start">
                <span className="text-2xl md:text-3xl font-black text-foreground">5K+</span>
                <span className="text-[8px] md:text-[10px] text-primary uppercase tracking-[0.2em] font-black">Verified Experts</span>
              </div>
            </motion.div>
          </div>
