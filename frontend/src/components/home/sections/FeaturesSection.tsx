      ...
      <div className="container mx-auto px-6">
        <div className="mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-black font-heading tracking-tight uppercase leading-tight mb-6">
            The <span className="text-primary">Haseri</span> Advantage.
          </h2>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 mb-24">
          ...
          >
            ...
            <h3 className="text-2xl md:text-3xl font-black uppercase tracking-tight mb-4 text-foreground">Verified Local Experts</h3>
            ...
            <ul className="space-y-3 font-medium text-foreground text-sm md:text-base">
          ...
          >
            <div className="relative border-8 md:border-[12px] border-white dark:border-slate-800 shadow-2xl z-10">
              <img 
            ...
            <div className="absolute -bottom-4 -right-4 md:-bottom-8 md:-right-8 w-32 h-32 md:w-64 md:h-64 bg-primary/10 -z-10" />
            <div className="absolute -top-4 -left-4 md:-top-8 md:-left-8 w-16 h-16 md:w-32 md:h-32 bg-foreground/5 -z-10" />
          </motion.div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row-reverse items-center gap-12 lg:gap-16">
          ...
          >
            ...
            <h3 className="text-2xl md:text-3xl font-black uppercase tracking-tight mb-4 text-foreground">Fast & Seamless Booking</h3>
            <p className="text-base md:text-lg text-muted-foreground leading-relaxed mb-6">
          ...
          >
            ...
            <div className="absolute -top-4 -left-4 md:-top-8 md:-left-8 w-32 h-32 md:w-64 md:h-64 bg-primary/10 -z-10" />
            <div className="absolute -bottom-4 -right-4 md:-bottom-8 md:-right-8 w-16 h-16 md:w-32 md:h-32 bg-foreground/5 -z-10" />
          </motion.div>
        </div>
